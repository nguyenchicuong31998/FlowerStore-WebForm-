<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/ADMIN.master" AutoEventWireup="true" CodeFile="ThemKhachHang.aspx.cs" Inherits="Admin_ThemKhachHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title-chung">Thêm khách hàng</div>
    <div class="dungchung">
        <div class="khoangcach">Họ và tên:</div><asp:TextBox ID="txttenkh" runat="server"></asp:TextBox>
        <div class="error">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Bạn vui lòng nhập họ và tên!" ControlToValidate="txttenkh" ForeColor="Red"></asp:RequiredFieldValidator>
        </div>
    </div>
    <div class="dungchung">
