    ...
    <form id="form1" runat="server">
        <div id="popup">
            <div id="popupcontrol">
                <hr class="gachchan" />
                <div class="dangnhap">
                    <div class="title-dn">ĐĂNG NHẬP ADMIN</div>
                    <div class="tendangnhap">
                        <asp:TextBox ID="txtdangnhap" CssClass="customdn" Placeholder="Tên đăng nhập" runat="server"></asp:TextBox>
                        <div class="eror">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Bạn vui lòng nhập tên tài khoản Admin!" ControlToValidate="txtdangnhap" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="matkhau">
                        <asp:TextBox ID="txtmatkhau" CssClass="customdn" Placeholder="Mật khẩu" runat="server" TextMode="Password"></asp:TextBox>
                        <div class="eror">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Bạn vui lòng nhập mật khẩu Admin!" ControlToValidate="txtmatkhau" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="btndn">
